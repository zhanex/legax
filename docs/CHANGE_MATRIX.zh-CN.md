...
| `scripts/lib/yaml.mjs`、`self-hosted-relay/lib/yaml.mjs`、`config.example*.yaml` | `docs/CONFIGURATION.zh-CN.md`、`docs/DOCUMENTATION.zh-CN.md` | `npm run check:docs`，相关消费配置的 E2E 测试，然后 `npm run check:node` |
