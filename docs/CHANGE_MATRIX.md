...
| `scripts/lib/yaml.mjs`, `self-hosted-relay/lib/yaml.mjs`, `config.example*.yaml` | `docs/CONFIGURATION.md`, `docs/DOCUMENTATION.md` | `npm run check:docs`, relevant config-consuming E2E tests, then `npm run check:node` |
